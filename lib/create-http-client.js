...
export default function createHttpClient (axios, httpClientParams) {
  const {space, accessToken, insecure, host, defaultHostname, httpAgent, httpsAgent, proxy, retryOnError, timeout} = httpClientParams
  ...
  const instance = axios.create({
    ...
    retryOnError: typeof retryOnError !== 'undefined' ? retryOnError : true,
